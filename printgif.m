...
[gifImage,gifMap] = rgb2ind(jpegImage,256,'nodither');
%and finally write the gif
imwrite(gifImage,gifMap,[filenameBase,'.gif'],'gif','Transparentcolor',0); %make the black bg to transparent! HFK
%imwrite(gifImage,gifMap,[filenameBase,'.gif'],'gif'); %make the black bg to transparent! HFK
